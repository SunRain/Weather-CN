...
Page {
    ...
    //property CityPage cityPage
    //property ProvincePage provincePage
    ...
    onSignalBusyIndicatorHide: {
        console.log("ccc qml -- onSignalBusyIndicatorHide");
    }

    Component.onCompleted: {
        console.log("ccc qml -- on townPage Completed for city id " + clickedTownID + "  " + clickItemDisplayName);
    }
    ...
    Component {
        ...
        Column {
            ...
            SilicaListView {
                ...
                header:  Item {
                    id: header
                    width: townPage.width//.width
                    height: pageHeader.height//townPage.height//headerContainer.height

                    Component.onCompleted: {
                        headerContainer.parent = header
                        console.log("ccc listViewComponet, on header complete")
                    }
                }

                model: locationProvider.getTownList
                ...
                delegate: BackgroundItem{
                    ...
                    Label {
                        ...
                        width: townPage.width-Theme.paddingLarge
                        anchors.verticalCenter: parent.verticalCenter
                    ...
                    onClicked: {
                        ...
                        console.log("ccc click item num <" + clickedTownID +">");
                        console.log(model.modelData.displayText);

                        weatherProvider.startFetchWeatherData(clickedTownID);
                        popToInfoPage();
                    }
                }
                ...
                Component.onCompleted: {
                    console.log("ccc listViewComponet, on listViewComponent complete")
                }
            }
        }
    }
    ...
    Connections {
        ...
        onFetchTownSucceed: {
            console.log("ccc qml -- onFetchTownSucceed");
            hideBusyIndicator(0);
        }

        onFetchTownFailed: {
            console.log("ccc qml -- onFetchTownFailed");
            hideBusyIndicator(1);
        }
    }
    ...
    function hideBusyIndicator(shouldShowErrorPage) {
        console.log("ccc qml -- hideBusyIndicator");
